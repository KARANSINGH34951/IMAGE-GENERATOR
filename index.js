...
//  cardtext1.innerHTML = data.alt_description; 
//   img2.src = results[store()].urls.regular;
// cardtext2.innerHTML = data.alt_description;
//   img3.src = results[store()].urls.regular;
// cardtext3.innerHTML = data.alt_description;
//   img4.src = results[store()].urls.regular;
// cardtext4.innerHTML = data.alt_description;
//   img11.src = results[store()].urls.regular;
// cardtext11.innerHTML = data.alt_description;
//   img21.src = results[store()].urls.regular;
// cardtext21.innerHTML = data.alt_description;
//   img31.src = results[store()].urls.regular;
// cardtext31.innerHTML = data.alt_description;
//   img41.src = results[store()].urls.regular;
// cardtext41.innerHTML = data.alt_description;
//   img12.src = results[store()].urls.regular;
// cardtext12.innerHTML = data.alt_description;
//   img22.src = results[store()].urls.regular;
// cardtext22.innerHTML = data.alt_description;
//   img32.src = results[store()].urls.regular;
// cardtext32.innerHTML = data.alt_description;
//   img42.src = results[store()].urls.regular;
// cardtext42.innerHTML = data.alt_description;
